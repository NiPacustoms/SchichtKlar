# JobFlow – Dokumentation Teil 97

*Zeichen 1907486–1927298 von 2862906*
...
**Empfehlung:**
```typescript
// Einheitliche Konstante in lib/config/payrollRules.ts
export const SOCIAL_INSURANCE_LIMITS_2025 = {
  health: 4987.50,
  pension: 7050.00,  // ✅ Korrekt für 2025
  unemployment: 7050.00,  // ✅ Korrekt für 2025
  care: 4987.50,
} as const;
```
...
### 2.2 Beitragssätze - KRITISCH

**Problem:** Falsche Beitragssätze in `socialSecurityCalculation.ts`

| Versicherung | Aktuell im Code | Korrekt 2025 | Status |
|--------------|-----------------|--------------|--------|
| ALV (Arbeitnehmer) | 1,3% | **1,2%** | ❌ **FALSCH** |
| Insolvenzgeldumlage | 0,09% | **0,06%** | ❌ **FALSCH** |

**Korrekte Werte 2025:**
- Arbeitslosenversicherung: **1,2%** (AN) + **1,2%** (AG) = 2,4% gesamt
- Insolvenzgeldumlage: **0,06%** (nur AG)

**Auswirkung:**
- Zu hohe Abzüge bei ALV
- Zu hohe AG-Kosten bei Insolvenzgeldumlage
- **Rechtliche Haftung**
...
private readonly rates = {
  // ...
  unemploymentInsuranceEmployee: 0.012, // ✅ 1,2% (nicht 0.013!)
  // ...
};

// Insolvenzgeldumlage
const insolvencyInsurance = grossSalary * 0.0006; // ✅ 0,06% (nicht 0.0009!)
```

---

### 2.3 Steuerberechnung - KRITISCH
