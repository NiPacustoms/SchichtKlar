# JobFlow – Dokumentation Teil 95

*Zeichen 1867707–1887594 von 2862906*

---

|-------|-------|--------------|--------|--------------|
| **Landing Page** | `/` | **95%** | 🟢 | Vollständige Landing Page mit Hero, Features, Footer, rollenbasierter Redirect |
| **Login** | `/login` | **95%** | 🟢 | Vollständig: Form-Validierung (Zod), OIDC-Support, Error Handling, Redirect-Logik |
| **Registrierung** | `/register` | **90%** | 🟢 | Vollständig: Validierung, Error Handling, Redirect nach Registrierung |
| **Auth Callback** | `/auth/callback` | **85%** | 🟡 | OIDC Callback Handler vorhanden |
...
|-------|-------|--------------|--------|--------------|
| **Impressum** | `/legal/imprint` | **100%** | 🟢 | Vollständige Impressum-Seite mit allen erforderlichen Informationen |
| **Datenschutz** | `/legal/privacy` | **100%** | 🟢 | Vollständige Datenschutzerklärung |
...
| Seite | Route | Ausarbeitung | Status | Beschreibung |
|-------|-------|--------------|--------|--------------|
| **Admin Dashboard** | `/admin/dashboard` | **95%** | 🟢 | Vollständig: KPIs, Quick Actions, Alerts, Statistics, Recent Activities, Realtime Updates |
| **Schichtverwaltung** | `/admin/shifts` | **98%** | 🟢 | Vollständig: CRUD, Filter, Suche, Kalender/Liste/Grid-Ansicht, Statistiken, Zuweisungen, Duplizieren |
