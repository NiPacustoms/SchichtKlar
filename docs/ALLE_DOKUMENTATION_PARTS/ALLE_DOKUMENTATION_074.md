# JobFlow – Dokumentation Teil 74

*Zeichen 1450428–1470269 von 2862906*

---

- `/chat` - `app/(app)/chat/page.tsx`
- `/chat/[channelId]` - `app/(app)/chat/[channelId]/page.tsx`
- `/chat/new` - `app/(app)/chat/new/page.tsx`
- `/messenger` - `app/messenger/page.tsx`
- `/messenger/[channelId]` - `app/messenger/[channelId]/page.tsx`
...
**API-Routes:**
- `/api/chat/channels` - Channel-Verwaltung
- `/api/chat/channels/[channelId]` - Channel-Details
- `/api/chat/messages` - Nachrichten-Verwaltung
- `/api/chat/messages/[messageId]` - Nachrichten-Details
- `/api/chat/upload` - Datei-Uploads
- `/api/chat/users` - User-Liste für Chat
- `/api/chat/typing` - Typing-Indikatoren
- `/api/chat/direct` - Direktnachrichten

**Firestore Collections:**
- `channels` - Chat-Kanäle
- `messages` - Nachrichten
- `chatChannels` - Neue Chat-Struktur (mit Subcollections)
- `typing` - Typing-Indikatoren

**Security:**
- Firestore Rules: Nur Channel-Teilnehmer können lesen/schreiben
- Storage Rules: Chat-Uploads nur für authentifizierte User (aber keine Channel-Prüfung - siehe `02_SECURITY_LEGAL_AUDIT.md`)
