# JobFlow – Dokumentation Teil 76

*Zeichen 1490136–1510021 von 2862906*
...
match /chatUploads/{channelId}/{fileName} {
  ...
  allow read: if request.auth != null && isChannelParticipant();
...
**Hinweis:** Firestore-Reads in Storage Rules kosten Geld. Alternative: Channel-Teilnehmer-Liste in Storage-Metadaten speichern (weniger sicher, aber günstiger).
...
**Test:**
- User A kann Uploads in Channel 1 lesen (wenn Teilnehmer)
- User B kann Uploads in Channel 1 NICHT lesen (wenn nicht Teilnehmer)

---

## Phase 4: Code-Qualität

**Ziel:** Fehlende Type-Properties und Exports hinzufügen  
**Aufwand:** 1-2 Tage  
**Priorität:** P1 - MUSS

### Schritt 4.1: Fehlende Type-Properties (bereits in Phase 1.3)

**Siehe:** Phase 1, Schritt 1.3

---

### Schritt 4.2: Fehlende Firebase-Exports (bereits in Phase 1.4)

**Siehe:** Phase 1, Schritt 1.4

---

### Schritt 4.3: Finale Verifikation
...
# Lint-Check (wenn ESLint installiert)
npm run lint
```

**Erwartetes Ergebnis:**
- ✅ TypeScript: 0 Fehler (möglicherweise noch Warnings)
- ✅ Build: Erfolgreich
- ✅ Lint: Erfolgreich (möglicherweise noch Warnings)
...
**Phase 1: Build-Fähigkeit**
- [ ] ESLint installiert
- [ ] Next.js 15 `params` Promise-Fix
- [ ] Fehlende Type-Properties hinzugefügt
- [ ] Fehlende Firebase-Exports hinzugefügt
- [ ] Fehlende Variablen/Funktionen behoben
- [ ] Type-Inkompatibilitäten behoben
- [ ] Build erfolgreich
...
- [ ] Datenexport-Funktion (DSGVO Art. 15)
- [ ] Datenlöschung-Funktion (DSGVO Art. 17)

**Phase 3: Security**
- [ ] `eval()` entfernt
- [ ] Chat-Content Sanitization
- [ ] Chat-Uploads Storage Rules

**Phase 4: Code-Qualität**
- [ ] Alle Type-Fehler behoben
- [ ] Finale Verifikation erfolgreich
...
- **Phase 2:** 2-3 Tage
- **Phase 3:** 1-2 Tage
- **Phase 4:** 1 Tag (größtenteils in Phase 1 erledigt)

**Gesamt:** 6-9 Arbeitstage

### Nach Abschluss

**Erwarteter Readiness-Score:** 80-90/100 🟢

**Verifikation:**
1. Alle Checks erfolgreich
2. Legal-Compliance erfüllt
3. Security-Probleme behoben
4. App ist verkaufsfertig

---

**Referenzen:**
- `docs/release/SALES_READINESS_REPORT_v2.md`
- `tasks/LAUNCH_SALES_READINESS_TODO.md`
...
### 📄 release/PRODUCTION_READINESS_AUDIT_RE_RUN.md
...
### 📄 release/RE_AUDIT_ISSUE_LIST.md

```markdown
# Re-Audit Issue List

**Erstellt:** 2025-01-27  
**Zweck:** Liste aller BLOCKER und MUSS Issues aus dem ersten Audit zur Verifikation
