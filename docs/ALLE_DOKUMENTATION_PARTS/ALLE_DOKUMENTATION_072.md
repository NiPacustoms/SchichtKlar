# JobFlow – Dokumentation Teil 72

*Zeichen 1410704–1430562 von 2862906*

---

- `/employee/chat` - `app/(employee)/employee/chat/page.tsx`
- `/employee/chat/[channelId]` - `app/(employee)/employee/chat/[channelId]/page.tsx`
- `/employee/dokumente` - `app/(employee)/employee/dokumente/page.tsx`
...
- `/employee/einrichtungen` - `app/(employee)/employee/einrichtungen/page.tsx`
- `/employee/benachrichtigungen` - `app/(employee)/employee/benachrichtigungen/page.tsx`
- `/employee/profil` - `app/(employee)/employee/profil/page.tsx`

### 1.4 App-Routes (gemeinsam genutzt, `app/(app)/`)
- `/chat` - `app/(app)/chat/page.tsx`
- `/chat/[channelId]` - `app/(app)/chat/[channelId]/page.tsx`
- `/chat/new` - `app/(app)/chat/new/page.tsx`

### 1.5 Legacy/Alternative Routes (Root-Level)
- `/` - `app/page.tsx` (Landing Page, redirects bei Auth)
...
- `/chat` - `app/chat/[channelId]/` (alternative Route)
