# JobFlow – Dokumentation Teil 108

*Zeichen 2125969–2145842 von 2862906*

---

- `INFO`: Normale Operationen
- `WARN`: Warnungen (z.B. hohe Überstunden)
- `ERROR`: Fehler (Berechnung fehlgeschlagen)

### 11.2 Metriken

**Zu tracken:**
- Durchschnittliche Berechnungszeit pro Mitarbeiter
- Durchschnittliche Berechnungszeit pro Periode
- Fehlerrate
- Anzahl Perioden pro Monat
- Durchschnittliche Mitarbeiteranzahl pro Periode

**Dashboard:** Firebase Console → Functions → Metrics

### 11.3 Alerts

**Zu konfigurieren:**
- Berechnungsfehlerrate > 5%
- Durchschnittliche Berechnungszeit > 5 Minuten
- Cloud Function Timeouts

**Tool:** Firebase Alerts oder externe Monitoring-Lösung (z.B. Sentry)

---

## 12. Edge Cases

### 12.1 Fehlende Timesheets

**Problem:** Aktiver Mitarbeiter, aber keine `approved` Timesheets in Periode

**Lösung:**
- Item erstellen mit `baseSalary` (falls monatlich) oder `0` (falls stündlich)
- `calcLog` markieren: "Keine Zeiterfassungen gefunden"
- Warnung in UI anzeigen

### 12.2 Überlappende Schichten

**Problem:** Timesheets mit überlappenden Zeiträumen

**Lösung:**
- Vor Berechnung prüfen: `endTime_1 > startTime_2`
- Blockieren oder markieren
- UI-Warnung: "Überlappende Zeiterfassungen gefunden für Mitarbeiter [Name]"

### 12.3 Kombinierte Zuschläge

**Problem:** Feiertag + Nacht + Überstunden am selben Intervall

**Lösung:**
- Zuschläge sind additiv: `hourlyRate × (1 + nightPercent + holidayPercent)`
- Überstunden-Faktor: `hourlyRate × overtimeMultiplier`
