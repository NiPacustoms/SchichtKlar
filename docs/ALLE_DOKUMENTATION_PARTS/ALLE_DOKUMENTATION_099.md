# JobFlow – Dokumentation Teil 99

*Zeichen 1947165–1967053 von 2862906*

---

#### Problem: Fehlende Client-seitige Validierung

**Viele Formulare validieren nur beim Submit:**
- Nutzer sieht Fehler erst nach Klick auf "Speichern"
- Keine Echtzeit-Validierung

**Empfehlung:** Validierung während der Eingabe (onBlur oder onChange).

### 3. Dialog-Konsistenz

#### Problem: Inkonsistente Dialog-Größen

**Verschiedene maxWidth-Werte:**
- `ConfirmDialog`: `maxWidth="sm"`
- `ConfirmDestructiveDialog`: `maxWidth="xs"`
- `ShiftCreateDialog`: vermutlich `maxWidth="md"`

**Code-Referenz:**
```15:15:components/common/ConfirmDialog.tsx
    <Dialog open={open} onClose={loading ? undefined : onClose} fullWidth maxWidth="sm">
```

**Empfehlung:** Einheitliche Dialog-Größen basierend auf Inhalt.

#### Problem: Fehlende Dialog-Animationen

**Alle Dialoge verwenden Standard-Animation:**
- Keine Custom-Transitions
- Könnte UX verbessern

### 4. Fehlende Funktionen

#### Problem: Bearbeiten-Button ohne Funktion

**Assignments-Seite:**
- "Bearbeiten"-Button existiert, aber keine onClick-Handler
...
**Empfehlung:** Entweder Funktion implementieren oder Button entfernen.
