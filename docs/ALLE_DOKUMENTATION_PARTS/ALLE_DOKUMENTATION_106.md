# JobFlow – Dokumentation Teil 106

*Zeichen 2086218–2106103 von 2862906*

---

**Korrektur:**
- ✅ Parameter `hasChildren` und `isOver23` hinzugefügt
- ✅ Korrekte Berechnung der Pflegeversicherung bei Kinderlosigkeit
...
Alle Werte sind korrekt und werden von anderen Services verwendet:
- ✅ Beitragsbemessungsgrenzen: 7.050€ (RV/ALV), 4.987,50€ (KV/PV)
- ✅ Beitragssätze: ALV 1,2%, Insolvenzgeldumlage 0,06%
- ✅ Minijob: 556€
- ✅ Midijob: 520,01€ - 2.000€
- ✅ Mindestlohn: 12,82€

### ✅ 2.2 Services verwenden zentrale Konfiguration

**Geprüfte Services:**
- ✅ `lib/services/payroll.ts`: Verwendet `getPayrollRules()`
- ✅ `lib/services/payroll/payrollCalculation.ts`: Verwendet `validateHourlyRate()`
- ✅ `lib/services/payroll/socialSecurityCalculation.ts`: Eigene Werte (könnte auf zentrale Konfiguration umgestellt werden)

**Empfehlung:** `socialSecurityCalculation.ts` sollte auch die zentrale Konfiguration verwenden (optional, für bessere Konsistenz).

---

## 3. Zusammenfassung der geänderten Dateien
...
2. ✅ `lib/services/payroll/socialSecurityCalculation.ts`
   - ALV: 0.013 → 0.012
   - Insolvenzgeldumlage: 0.0009 → 0.0006 (3 Stellen)
   - Beitragsbemessungsgrenzen: 7550 → 7050, 5175 → 4987.50
   - Minijob: 538 → 556
   - Midijob: 538 → 520.01
