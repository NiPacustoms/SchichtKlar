...
| S2 | Persönlicher Entwicklerpfad inkl. Key-Pfad `/Users/patrickschmidt/.keys/jobflow25-admin.json` | `scripts/sync-custom-claims.js:30` | **anonymisieren** (Pfad durch ENV/Arg ersetzen) |
