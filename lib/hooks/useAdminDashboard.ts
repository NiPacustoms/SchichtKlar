...
export const useAdminDashboard = () => {
  ...
  const { data: timesheetsData, isLoading: _loadingTimesheets } = useQuery<Timesheet[]>({
  ...
  const { data: documentsData, isLoading: _loadingDocuments } = useQuery<Doc[]>({
  ...
  const { data: activitiesData, isLoading: _loadingActivities } = useQuery<Activity[]>({
