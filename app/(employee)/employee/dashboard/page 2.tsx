          ...
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <Box sx={{ display: 'flex', alignItems: 'center' }}>
              <Chip
                ...
                color="success"
                size="small"
                sx={{ backgroundColor: 'rgba(46, 125, 50, 0.2)', mr: 2 }}
              />
              <Box>
                <Typography
                  variant="h6"
                ...
                <Typography
                  ...
                  sx={{ color: isDark ? 'rgba(255,255,255,0.72)' : 'rgba(0,0,0,0.7)' }}
                >
                  Letzte Überprüfung: vor 2 Minuten
                </Typography>
              </Box>
            </Box>
            <Box
  ...
  return (
    <Box sx={{ maxWidth: 1200, mx: 'auto', p: 3, pb: 10 }}>
        <Box sx={{ textAlign: 'center', mb: 4 }}>
          ...
          >
            {isNurse ? 'Willkommen zurück!' : 'Admin Dashboard'}
          </Typography>
          <Typography
            variant="body1"
            sx={{ color: isDark ? 'rgba(255,255,255,0.72)' : 'rgba(0,0,0,0.7)' }}
          >
            {isNurse ? 'Hier ist dein Überblick für heute' : 'Überblick über alle Bereiche'}
          </Typography>
        </Box>
